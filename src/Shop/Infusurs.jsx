    ...
    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
        <img
          ...
          alt="BRAUN Infusomat fms Infusionspumpe"
        />
        <div className="p-4">
          <div className="text-sm text-gray-600">Produktnummer: 1002518</div>
          <h2 className="text-lg font-bold text-gray-900 mt-2">
            BRAUN Infusomat fms Infusionspumpe
          </h2>
          <p className="text-sm text-gray-600 mt-1">BRAUN Infusomat fms Infusionspumpe Für Netz- und Batteriebetrieb. 0,1 ml</p>
      ...
      <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
        <img
          ...
          alt="B. BRAUN FM Controller mit FM-Computer"
        />
        <div className="p-4">
          <div className="text-sm text-gray-600">Produktnummer: 1003307</div>
          <h2 className="text-lg font-bold text-gray-900 mt-2">
            B. BRAUN FM Controller mit FM-Computer
          </h2>
          <p className="text-sm text-gray-600 mt-1">B. BRAUN FM Controller mit FM-Computer und Möglichkeit zur Nutzung von 3 Perfusoren FM o</p>
