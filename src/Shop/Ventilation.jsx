  ...
  return (
    <>
      <div className="row">
        ...
        <div className="col-lg-5">
          <h5 className="text-black font-bold mt-5">Anaesthesia and ventilation</h5>
          <p className="text-black">
            We offer anaesthetic equipment for all sectors: human medicine, veterinary medicine and research...
          </p>
          <h5 className="text-black font-bold">Information for Supplies and Services</h5>
          <p className="text-black">
            All anesthesia devices to be used in the field of veterinary medicine consist of basic unit...
          </p>
        </div>
        <div className="col-lg-1"></div>
      </div>
        ...
        <div className="col-lg-7 mt-4">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <div className="text-sm text-gray-600">Product number: 1005211</div>
                <h2 className="text-lg font-bold text-gray-900 mt-2">
                  DRÄGER 5704281 Wall bracket for Oxylog 2000plus
                </h2>
                <br />
                <br />
                <br />
                ...
                <p className="text-sm text-gray-600 mt-1">DRÄGER 5704281 Wall bracket for Oxylog 2000plus, Second-hand</p>
            ...
            <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <div className="text-sm text-gray-600">Product number: 1005245</div>
                <h2 className="text-lg font-bold text-gray-900 mt-2">
                DRÄGER Evita Infinity V500 Intensive care ventilator
                </h2>
                <br />
                <br />
                <br />
                ...
                <p className="text-sm text-gray-600 mt-1">DRÄGER Evita Infinity V500 Intensive care ventilator for adults, children and</p>
            ...
            <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <div className="text-sm text-gray-600">Product number: 1000867</div>
                <h2 className="text-lg font-bold text-gray-900 mt-2">
                DRÄGER Secretion bottle package                </h2>
                <br />
                <br />
                <br />
                <br />
                
                <p className="text-sm text-gray-600 mt-1">DRÄGER secretion bottle package consisting of carrying frame, 2x</p>
            ...
            <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <div className="text-sm text-gray-600">Product number: 1005315</div>
                <h2 className="text-lg font-bold text-gray-900 mt-2">
                DRÄGER Perseus A500, mobile anaesthesia workstation
                </h2>
                <br />
                <br />
                <br />
                ...
                <p className="text-sm text-gray-600 mt-1">DRÄGER Perseus A500, mobile anaesthesia workstation for adults,</p>
            ...
            <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <h2 className="text-lg font-bold text-gray-900 mt-2">
                ALL ANAESTHESIA DEVICES TO BE USED IN THE FIELD OF VETERINARY               </h2>
                <br />
                <br />
                <br />
                <br />
                
                <p className="text-sm text-gray-600 mt-1">ALL ANAESTHESIA DEVICES TO BE USED IN THE FIELDOF VETERINARY</p>
